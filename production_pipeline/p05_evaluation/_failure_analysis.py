...
results = json.load(open("production_pipeline/experiments/benchmark_query_results.json"))
ner_map = {
    a["id"]: a
    for a in json.load(open("production_pipeline/p02_eda/experiments/topic_assignments_all.json"))
    ["results"]["BAAI/bge-base-en-v1.5"]["assignments"]
}
...
# 3. Top 5 false positives (failures with highest rank score)
