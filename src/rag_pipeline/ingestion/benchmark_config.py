...
class BenchmarkConfig:
    ...
    def from_defaults(cls) -> 'BenchmarkConfig':
        ...
        return cls(
            ...
            clean_path=Paths.clean_jsonl(),
            topic_path=Paths.topic_assignments(),
            configs_path=Paths._resolve('retrieval_configs'),
            output_dir=Paths.reranker_results_dir(),
            cache_dir=Paths._resolve('embeddings_cache_dir'),
