...
COURSES = ['llm-zoomcamp', 'mlops-zoomcamp', 'data-engineering-zoomcamp', 'machine-learning-zoomcamp']
    ...
    try:
        ...
        with zipfile.ZipFile(zip_path, 'r') as zf:
            ...
            for course in COURSES:
                ...
                course_files = [name for name in all_names if name.startswith(source_prefix) and name.endswith('.md')]
                if not course_files:
                ...
                file_count = sum((1 for _, _, fnames in os.walk(course_dir) for f in fnames if f.endswith('.md')))
